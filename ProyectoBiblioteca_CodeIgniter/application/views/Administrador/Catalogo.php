<div class="container">
        ...
        <div class="container-fluid" style="margin: 50px 50px;">
            <form class="form" action="<?=base_url()?>Administrador/Buscar" method="POST">
        ...
        <div class="container-fluid" style="margin: 0 0 50px 0;">
            ...
            <ul class="list-unstyled text-center list-catalog-container">
                <li class="list-catalog"><a href="<?=base_url()?>Administrador/Catalogo">Todas</a></li>
                <?php foreach ($categorias as $categoria) : ?> 
                <li class="list-catalog"><a href="<?=base_url()?>Administrador/CategoriaSeleccionada?cat=<?=$categoria->CodCat?>"><?=$categoria->DescCat?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
            ...
            <div class="media media-hover">
                ...
                <div class="media-body">
                    ...
                    <p class="text-center pull-right">
                        <a href="#!" class="btn btn-info btn-xs" data-toggle="modal" data-target="#exampleModalCenter" style="margin-right: 10px;"><i class="zmdi zmdi-info-outline"></i> &nbsp;&nbsp; Más información</a>
                    </p>
                </div>
            </div>
             <?php endforeach;} else{  ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">En proceso</h5>
      </div>
      <div class="modal-body">
        Ahora no Joven estamos Trabajando
      </div>
