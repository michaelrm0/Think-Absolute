        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="<?=base_url()?>Administrador/NuevoAdministrador">Nuevo Administrador</a></li>
        ...
        <div class="container-fluid">
            <h2 class="text-center all-tittles">Lista de administradores activos</h2>          
              <table id="tbladmi" class="table table-bordered table-striped">
                ...
                <tbody>     
                    ...
                    <?php foreach ($administradores as $ad) :?>           
                    <tr>
                       <td><?= $ad->NombPer." ".$ad->ApePer ?></td>
                       <td><?= $ad->NombBibli ?></td>
                       <td>
                           <center>
                                <div class="btn-group">                     
                                ...
                                '<?= $ad->Usuario ?>',
                                '<?= $ad->Clave ?>',
                                '<?= $ad->NombBibli ?>')" class="btn btn-info" data-toggle="modal" data-target="#veradmi">
                        ...
                        <td>                            
                            <center>
                                ...
                                '<?= $ad->CorPer ?>',
                                '<?= $ad->DniPer ?>',         
                                '<?= $ad->NombBibli ?>')" class="btn btn-warning" data-toggle="modal" data-target="#modadmi">
                        ...
                        <td>
                            <center>
                                <form method="post" action="<?= base_url(); ?>Administrador/DesactivarAdministrador">
                                    <input type="hidden" name="txtcodusu" value="<?= $ad->CodUsu ?>">
                                    <input type="hidden" name="txtcodper" value="<?= $ad->CodPer ?>">                    
                                    <input type="hidden" name="txtcodad" value="<?= $ad->CodAd ?>">
                                    <div class="btn-group">
