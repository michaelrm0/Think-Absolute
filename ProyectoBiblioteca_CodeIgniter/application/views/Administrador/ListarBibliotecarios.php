        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                     Bienvenido a la sección donde se encuentra el listado de lo(a)s bibliotecario(a)s registrados en el sistema, puedes actualizar algunos datos  o eliminar el registro completo del personal administrativo siempre y cuando no tenga préstamos pendientes. 
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="<?=base_url()?>Administrador/NuevoBibliotecario">Nuevo Bibliotecario</a></li>
                        <li class="active">Listado de Bibliotecario(a)s</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <h2 class="text-center all-tittles">Lista de bibliotecario(a)s activos</h2>          
              <table id="tblbibl" class="table table-bordered table-striped">
                <thead class="div-table-head">
                <tr>
                  <th>Nombre y Apellido</th>
                  <th>Biblioteca a Cargo</th>
                  <th>Ver</th>
                  <th>Modificar</th>
                  <th>Eliminar</th>
                </tr>
	                    ...
	                    <tr>
	                       ...
	                       <td>
	                           <center>
	                                ...
	                                '<?= $bi->Usuario ?>',
	                                '<?= $bi->Clave ?>',
	                                '<?= $bi->NombBibli ?>')" class="btn btn-info" data-toggle="modal" data-target="#veradmi">
	                        ...
	                        <td>                            
	                            <center>
	                                ...
	                                '<?= $bi->CorPer ?>',
	                                '<?= $bi->DniPer ?>',         
	                                '<?= $bi->NombBibli ?>')" class="btn btn-warning" data-toggle="modal" data-target="#modadmi">
	                        ...
	                        <td>
	                            <center>
	                                <form method="post" action="<?= base_url(); ?>Administrador/DesactivarBibliotecario">
	                                    <input type="hidden" name="txtcodusu" value="<?= $bi->CodUsu ?>">
	                                    <input type="hidden" name="txtcodper" value="<?= $bi->CodPer ?>">                    
	                                    <input type="hidden" name="txtcodbib" value="<?= $bi->CodBib ?>">
	                                    <div class="btn-group">
          ...
          <div class="modal fade" id="veradmi">       
        ...
        <form method="post" action="<?php echo base_url() ?>Administrador/ModificarBibliotecario">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-purple-active">
                            ...
                            <h4 class="modal-title">Modificar Datos del Bibliotecario</h4>
                        </div>                
                        <div class="modal-body">
                            <div class="post">
                                <div class="row">
